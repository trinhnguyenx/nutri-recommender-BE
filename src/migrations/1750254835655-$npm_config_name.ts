...
export class  $npmConfigName1750254835655 implements MigrationInterface {
    name = ' $npmConfigName1750254835655'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`meal_plans\` (\`id\` varchar(36) NOT NULL, \`name\` varchar(255) NOT NULL, \`start_date\` date NOT NULL, \`is_active\` tinyint NOT NULL DEFAULT 1, \`maintenanceCalories\` float NOT NULL, \`targetCalories\` float NOT NULL, \`goal\` varchar(255) NOT NULL, \`estimatedWeeklyChange\` float NULL, \`estimatedDaysToGoal\` int NULL, \`userId\` varchar(36) NULL, \`calculationResultId\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
